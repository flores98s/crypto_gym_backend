# Generated by Django 4.0.4 on 2022-11-29 03:49
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cai', models.CharField(max_length=50, validators=[django.core.validators.MinLengthValidator(3), api.validators.validate_nombre])),
                ('fechaEmision', models.DateField(validators=[api.validators.validate_fecha])),
                ('fechaVencimiento', models.DateField(validators=[api.validators.validate_fecha])),
